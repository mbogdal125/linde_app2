...
class ChoseStocksheetView(ListView):
    ...
    def  get_queryset(self):
        p = Paginator(StockSheet.objects.order_by('-stock_sheet_number').filter(id_stocktaking__stocktaking_number=self.kwargs['stocktaking_number'],status__lte=2), 15)
